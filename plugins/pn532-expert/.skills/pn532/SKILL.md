...
- Complete command reference with byte formats
- Register map and configuration options
- Protocol-specific sequences
- Timing specifications
- Error code definitions

Reference this for accurate details. If it doesn't exist but PDFs are in `knowledge/`, suggest `/pn532-init-docs`.
...
When activated:
1. Acknowledge the PN532 context
2. Reference documentation when providing specific values
3. Show complete frame examples with all bytes
4. Highlight timing-critical operations
5. Suggest the `/pn532-*` commands for deeper analysis
