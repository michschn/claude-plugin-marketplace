...
First, check for cached documentation in the plugin's knowledge directory at `.skills/lvgl/knowledge/`. If documentation is missing or stale (>7 days old), fetch fresh documentation from docs.lvgl.io.

### Key LVGL Modules to Recommend
...
3. **Fetch if needed**: Get latest docs from docs.lvgl.io for specific widgets
4. **Provide specific recommendations**: Name exact widgets, APIs, and show examples
5. **Explain tradeoffs**: Why LVGL's built-in approach is better
